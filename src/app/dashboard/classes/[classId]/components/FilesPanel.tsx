...
import { QualityBadge, extractionBadge, NOTES_TIPS_HREF } from '@/components/QualityBadge';
              ...
              return (
                <tr key={f.id} className="border-b border-line last:border-0">
                  ...
                  <td className="px-5 py-3.5 text-xs">
                    ...
                    {f.status === 'READY' && (
                      <span className="ml-2">
                        <QualityBadge {...extractionBadge(f.extractedChars)} tipsHref={NOTES_TIPS_HREF} />
                      </span>
                    )}
                  </td>
