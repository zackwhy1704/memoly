      ...
      {submitted ? (
        ...
        <div style={{ width: '100%', maxWidth: 440 }}>
          ...
          <p style={{ color: '#6B618A', fontSize: 14, textAlign: 'center', marginBottom: 28, lineHeight: 1.6 }}>
            Tell us about your centre and we&apos;ll set you up within one business day — no card required.
          </p>

          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <Field label="Organisation / centre name" id="su-org"  type="text"  value={orgName}      onChange={setOrgName}      placeholder="Bright Stars Tuition" />
            <Field label="Your name"                  id="su-name" type="text"  value={contactName}  onChange={setContactName}  placeholder="Jane Smith"           />
            <Field label="Work email"                 id="su-em"   type="email" value={email}        onChange={setEmail}        placeholder="jane@brightstar.edu"  />
            <Field label="Contact number"             id="su-ph"   type="tel"   value={phone}        onChange={setPhone}        placeholder="+65 9123 4567"        />
  ...
  return (
    <div style={{ textAlign: 'center', maxWidth: 420 }}>
      ...
      <p style={{ color: '#6B618A', fontSize: 15, lineHeight: 1.6, marginBottom: 28 }}>
        We&apos;ve received your request and will reach out within one business day to get your centre set up.
      </p>
      ...
      {CALENDLY ? (
        ...
        <p style={{ color: '#A8A0BD', fontSize: 14 }}>
          We&apos;ll email you a booking link shortly.
        </p>
      )}
