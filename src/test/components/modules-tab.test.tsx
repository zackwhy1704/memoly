...
describe('masteryPct (Modules mastery guard)', () => {
  it('rounds a 0–100 mastery to an integer percent (backend contract — NOT ×100)', () => {
    expect(masteryPct(72.6)).toBe(73);
    expect(masteryPct(40)).toBe(40);
    expect(masteryPct(100)).toBe(100);
    expect(masteryPct(150)).toBe(100); // clamp — no legacy row renders >100%
